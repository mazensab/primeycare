...
/* ============================================================
   ...
   🧠 Primey Care | Create Treasury Receipt Voucher
   ------------------------------------------------------------
...
const translations = {
  ar: {
    title: "إنشاء سند قبض",
    subtitle: "تسجيل سند قبض جديد داخل الخزينة مع الحساب والمبلغ والطرف والمرجع.",
    back: "سندات الخزينة",
    treasury: "الخزينة",
    ...
    summary: "ملخص السند",
    summaryDesc: "راجع بيانات سند القبض قبل الحفظ.",
    ...
    createdDraft: "تم حفظ سند القبض كمسودة.",
    createdConfirmed: "تم إنشاء وتأكيد سند القبض بنجاح.",
    submitError: "تعذر حفظ سند القبض.",
    errorTitle: "تعذر تجهيز صفحة سند القبض",
    errorDesc: "تأكد من تشغيل الباكند ثم أعد المحاولة.",
    noAccountsTitle: "لا توجد حسابات خزينة",
    noAccountsDesc: "أضف صندوقًا أو حسابًا بنكيًا قبل إنشاء سند قبض.",
  ...
  en: {
    ...
    subtitle: "Record a new treasury receipt voucher with account, amount, party, and reference.",
    ...
    voucherData: "Receipt voucher data",
    ...
    summaryDesc: "Review the receipt voucher data before saving.",
    ...
    createdDraft: "Receipt voucher saved as draft.",
    createdConfirmed: "Receipt voucher created and confirmed successfully.",
    submitError: "Unable to save receipt voucher.",
    errorTitle: "Unable to prepare receipt voucher page",
    errorDesc: "Make sure the backend is running, then try again.",
    noAccountsTitle: "No treasury accounts",
    noAccountsDesc: "Add a cashbox or bank account before creating a receipt voucher.",
    tryAgain: "Try again",
    notAvailable: "—",
    sar: "SAR",
  },
...
export default function TreasuryReceiptVoucherPage() {
  ...
  function buildPayload(mode: SubmitMode) {
    return {
      ...
      description: form.description.trim() || t.receiptVoucher,
            ...
            <Card className="rounded-lg border bg-card shadow-none">
              ...
              <CardContent className="space-y-4 px-6 pb-6">
                <div className="rounded-lg border bg-background p-4">
                  <div className="mb-1 text-xs text-muted-foreground">{t.incoming}</div>
              ...
              <CardContent className="flex items-start gap-3 p-4 text-right">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm leading-6 text-muted-foreground">
                    {locale === "ar"
                      ? "عند حفظ وتأكيد السند سيتم إرساله للباكند كسند قبض مؤكد مع تطبيق أثر الرصيد إذا كان مدعومًا."
