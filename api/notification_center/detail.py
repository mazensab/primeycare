# ============================================================
# 📂 api/notification_center/detail.py
# Primey Care - Notification Center Detail API
# ============================================================
...
@require_GET
def notification_center_detail_api(request):
    ...
    return json_success(
        "Notification center detail loaded successfully",
