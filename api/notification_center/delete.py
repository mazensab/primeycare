# ============================================================
# 📂 api/notification_center/delete.py
# Primey Care - Notification Center Delete API
# ============================================================
...
@transaction.atomic
def notification_center_delete_api(request):
    ...
    try:
        ...
        return json_success(
            "Notification center record deleted successfully",
            data={
                "resource": resource,
        ...
        return json_error(
            "Failed to delete notification center record",
            error="DELETE_FAILED",
            status=500,
            details=str(exc),
        )